...
use prologue_logger::style::{NoStyler, DefaultConsoleStyler};

fn main() -> prologue_logger::error::Result<(), DefaultConsoleStyler> {
    let logger = PrologueLogger::<DefaultConsoleStyler>::new();
